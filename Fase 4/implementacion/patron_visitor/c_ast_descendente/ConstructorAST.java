...
public class ConstructorAST implements ConstructorASTConstants {
	...
	final public Declaracion DECVAR() throws ParseException {
		...
		{
			if (true)
				return sem.decvar(tipo, sem.str(iden.image, iden.beginLine, iden.beginColumn));
		}
		throw new Error("Missing return statement in function");
	}
	...
	final public Declaracion DECTIPO() throws ParseException {
		...
		{
			if (true)
				return sem.dectipo(tipo, sem.str(iden.image, iden.beginLine, iden.beginColumn));
		}
		throw new Error("Missing return statement in function");
	}
	...
	final public Declaracion DECPROC() throws ParseException {
		...
		{
			if (true)
				return sem.decproc(sem.str(iden.image, iden.beginLine, iden.beginColumn), pforms, bl);
		}
		throw new Error("Missing return statement in function");
	}
	...
	final public ParamForm RPFORMAL(Tipo t) throws ParseException {
		...
		case 50:
			...
			if (true)
				return sem.pformal_ref(t, sem.str(id.image, id.beginLine, id.beginColumn));
		}
			break;
		case identificador:
			id = jj_consume_token(identificador); {
			if (true)
				return sem.pformal(t, sem.str(id.image, id.beginLine, id.beginColumn));
		}
			break;
		default:
			jj_la1[5] = jj_gen;
	...
	final public Tipo TIPO() throws ParseException {
		...
		case identificador:
			id = jj_consume_token(identificador); {
			if (true)
				return sem.tipo_id(sem.str(id.image, id.beginLine, id.beginColumn));
		}
			break;
		case ARRAY:
			...
			t = TIPO(); {
			if (true)
				return sem.tipo_array(sem.str(le.image, le.beginLine, le.beginColumn), t);
		}
			break;
		case RECORD:
	...
	final public Tipo TIPO_BASICO() throws ParseException {
		...
		case REAL:
			...
			if (true)
				return sem.real_cons();
		}
			break;
		case BOOL:
			jj_consume_token(BOOL); {
			if (true)
				return sem.bool_cons();
		}
			break;
		case STRING:
			jj_consume_token(STRING); {
			if (true)
				return sem.string_cons();
		}
			break;
		default:
			jj_la1[7] = jj_gen;
	...
	final public Camp CAMPO() throws ParseException {
		...
		{
			if (true)
				return sem.campo(t, sem.str(id.image, id.beginLine, id.beginColumn));
		}
		throw new Error("Missing return statement in function");
	}
	...
	final public Instruccion INSTRUCCION() throws ParseException {
		...
		case WHILE:
			...
			if (true)
				return sem.while_inst(ex, l_ins);
		}
			break;
		case READ:
		...
		case CALL:
			...
			jj_consume_token(48); {
			if (true)
				return sem.call(sem.str(id.image, id.beginLine, id.beginColumn), l_exp);
		}
			break;
		case 53:
			b = BLOQUE(); {
			if (true)
				return sem.bloque_inst(b);
		}
			break;
		default:
			jj_la1[10] = jj_gen;
	...
	final public Instruccion RIf(Exp ex, Instrucciones l_ins) throws ParseException {
		...
		case ELSE:
			...
			jj_consume_token(ENDIF); {
			if (true)
				return sem.if_else(ex, l_ins, l_ins1);
		}
			break;
		default:
			jj_la1[11] = jj_gen;
	...
	final public Bloque RBLOQUE() throws ParseException {
		...
		case 60:
			p = PROGRAMA(); {
			if (true)
				return sem.bloque_prog(p);
		}
			break;
		default:
			jj_la1[16] = jj_gen; {
			if (true)
				return sem.no_bloque();
		}
		}
		throw new Error("Missing return statement in function");
	}
	...
	final public Exp EXPRESION_BASICA() throws ParseException {
		...
		case identificador:
			...
			if (true)
				return sem.id(sem.str(t.image, t.beginLine, t.beginColumn));
		}
			break;
		case NULL:
		...
		case litEnt:
			...
			if (true)
				return sem.litEnt(sem.str(t.image, t.beginLine, t.beginColumn));
		}
			break;
		case litReal:
			t = jj_consume_token(litReal); {
			if (true)
				return sem.litReal(sem.str(t.image, t.beginLine, t.beginColumn));
		}
			break;
		case litCad:
			t = jj_consume_token(litCad); {
			if (true)
				return sem.litCad(sem.str(t.image, t.beginLine, t.beginColumn));
		}
			break;
		default:
			jj_la1[17] = jj_gen;
	...
	final public Exp RE5(Exp exph) throws ParseException {
		...
		case 51:
			...
			exp = EXPRESION();
			jj_consume_token(52);
			resul = RE5(sem.exp("[]", exph, exp, null)); {
			if (true)
				return resul;
		}
			break;
		case 58:
			jj_consume_token(58);
			iden = jj_consume_token(identificador);
			resul = RE5(sem.exp(".", exph, null, sem.str(iden.image, iden.beginLine, iden.beginColumn))); {
			if (true)
				return resul;
		}
			break;
	...
	private static void jj_la1_0() {
		jj_la1_0 = new int[] { 0x12387000, 0x0, 0x100000, 0x60078000, 0x0, 0x0, 0x60078000, 0x78000, 0x0, 0x0,
				0x12287000, 0x1800000, 0x12287000, 0x0, 0x87000, 0x0, 0x12387000, 0x86000, 0x0, 0xc00, 0x0, 0x0,
				0x87000, 0x0, 0x86000, 0x86000, 0xc00, 0x0, 0x0, };
	}

	private static void jj_la1_1() {
		jj_la1_1 = new int[] { 0x12209efe, 0x4000, 0xc0, 0x401, 0x20000, 0x40400, 0x401, 0x0, 0x4000, 0x4000,
				0x12209e3e, 0x0, 0x12209e3e, 0x4000, 0x12009e00, 0x20000, 0x12209efe, 0x1e00, 0x3000000, 0x0,
				0xe0000000, 0x10000000, 0x12009e00, 0xc080000, 0x10009e00, 0x9e00, 0x0, 0xe0000000, 0x10000000, };
	}

	private static void jj_la1_2() {
		jj_la1_2 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x7, 0x18, 0x0, 0x0, 0x0, 0x0, 0x0, 0x7, 0x18, };
	}
